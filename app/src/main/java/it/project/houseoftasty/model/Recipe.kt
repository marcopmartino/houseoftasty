...
data class Recipe(
    ...
    @get: PropertyName("likes") var likes: List<String?> = emptyList(),
    @get: PropertyName("likeCounter") var likeCounter: Int? = null,
    @get: PropertyName("visual") var visual: Int? =null,
